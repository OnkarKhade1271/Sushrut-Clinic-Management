...
<nav class="green-navbar">
  ...
  <div class="container">
    <form action="./MedicinesGive.jsp" method="post">
      <h1>Give Medicines</h1>

      <div class="input-group">
        <label>Medicine id: </label>
        <input type="text" placeholder="Enter medicine" name="medicine_id" >
        <span id="name-error"></span>
      </div>
<div class="input-group">
        <label>Enter Person Name: </label>
        <input type="text" placeholder="Enter Person Name" name="name" onkeyup="validateName()">
        <span id="name-error"></span>
      </div>

<div class="input-group">
	<label>Select the Reason: </label>
        <select id="selectOption" name="selectReason">
