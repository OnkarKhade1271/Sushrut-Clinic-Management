...
<%
	...
	PreparedStatement pstmt=con.prepareStatement("select * from offline_patients where todays_date between ? and ?");
	...
	while(rs.next())
	{
		%>
	<tr>
<td><%=rs.getString("op_name") %></td>
<td><%=rs.getString("gender") %></td>
<td><%=rs.getString("age") %></td>
<td><%=rs.getDate("todays_date") %></td>
