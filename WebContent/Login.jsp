...
<br>
            <div class="input-group">
                <label>Email: </label>
                <input type="text" placeholder="Enter email" id="Cust-username" name="email" onkeyup="validateUsername()">
...
<br>
            <div class="input-group">
                ...
                <input type="password" placeholder="Enter Password" name="pass" id="Cust-password" onkeyup="validatePassword()">
...
<br>
            ...
            <span class="footer">If you are new on our website then<a href="Registration.html">Register</a></span>
            <span class="footer">If you forgot password then <a href="ForgetPassword.jsp">Forgot Password</a></span>
...
PreparedStatement ps=con.prepareStatement("select p_name, p_email,p_password from patient where p_email=?");
...
session.setAttribute("username",p_name);
