...
<nav class="green-navbar">
  ...
  <div class="container">
    <form action="./AddMedicinesServlet" method="post">
      <h1>Add Medicines</h1>

      <div class="input-group">
        <label>Medicine Name: </label>
        <input type="text" placeholder="Enter medicine name" id="Patient-name" name="medicine_name" onkeyup="validateName()">
        <span id="name-error"></span>
      </div>

      <div class="input-group">
        <label>Quantity: </label>
        <input type="number" placeholder="Enter Quantity" id="qty" name="quantity" required>
        <span id="qty-error"></span>

      </div>
          <div class="input-group">
        <label>Price: </label>
        <input type="number"  id="qty" name="price" required>
        <span id="qty-error"></span>
 ...
 <div class="input-group">
      ...
      <div class="input-group">
        ...
        <select id="selectOption" name="best_before">
      ...
      <div class="input-group">
        ...
        <textarea  id="Description" name="desc" onkeyup="validateDesc()" required></textarea>
        <span id="desc-error"></span>

      </div>

           <center>
        <input type="submit" value="Add" id="submit" name="submit" onclick="return validateForm()">
  ...
  {
	  var age=document.getElementById('qty').value;
	  if(age<=1 || age>100)
		  {
