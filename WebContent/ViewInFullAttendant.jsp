<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="java.sql.*" %>
    ...
    try
   	...
   	PreparedStatement pstmt=con.prepareStatement("select * from presc2 where presc_id=? ");
   	pstmt.setInt(1,id1);
...
<div class="container">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text"  value="<%=rs.getString("p_email") %>" id="patientId" name="pid" readonly>
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn"><a href="MenuAtt.jsp">Back</a></button>
    </form>
</div>
<% 
	}
