...
<nav class="green-navbar">
  ...
  <div class="container">
    <form action="./AddHistory.jsp" method="post">
      ...
      <div class="input-group">
        ...
        <input type="numeric"  name="bp" min="1" max="140" required>
        <span id="name-error"></span>
      </div>
...
<div class="input-group">
	...
	<label>Heart disease : </label>
         <input type="text"  name="heart" required>
      </div>
      <div class="input-group">
	<label>Any Drug Allergies : </label>
         <input type="text"  name="allergies" min="1" max="140" required>
      </div>
           <center>
